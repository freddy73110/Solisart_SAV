    ...
    if (configInstantane['Type_Appoint(0)'] == '0'){
        ...
        if (configInstantane['tr(2)'] != '0pC'){
            ...
            if (configInstantane['v3v(0)'] == 0){
                ...
                $("#"+schemaID).find(".divTampon").find(".vertical").find(".CF, .CC").addClass("bg-danger progress-bar-striped progress-bar-animated")
                $("#"+schemaID).find(".divCapteurs").find(".CF, .CC").addClass("bg-danger progress-bar-striped progress-bar-animated")                 
