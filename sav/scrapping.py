...
def send_channel_message(group_name, message):
    ...
    async_to_sync(channel_layer.group_send)("{}".format(group_name), message)
...
class scrappingMySolisart:
    ...
    def __init__(self):
        try:
            send_channel_message(
                "cartcreating",
                {"message": "Lancement du scrapping", "processing": True},
            )
            if not os.name == "nt":
                import subprocess
                ...
                if subprocess.call("killall -9 firefox", shell=True) > 0:
                    ...
                    send_channel_message(
                        "cartcreating", {"message": "Arrêt du firefox"}
                    )
            ...
            send_channel_message(
                "cartcreating", {"message": "Connexion au serveur my.solisart.fr"}
            )
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-times' style='color: #fe0101;'></i> Erreur: "
                    + str(exc_type)
                    + str(fname)
    ...
    def listExportData(self, instal=None):
        self.driver.get(
            "https://my.solisart.fr/admin/index.php?page=installation&id=" + instal
        )
        time.sleep(1)
        self.waitelement(
            By.XPATH,
            '//label[@for="input-pages-maj"]',
        ...
        self.waitelement(
            By.XPATH,
            '//a[@href="#onglet-export"]',
            "presence_of_element_located",
            "click",
        )
        time.sleep(1)
        dates = self.waitelement(
            By.XPATH,
            '//*[@class="liste_colonne_impaire"]/a',
    ...
    def downloadDatascv(self, instal=None, date=None):
        ...
        for link in [
            s
            for s in self.listExportData(instal=instal)
            if any(xs in s for xs in matchers)
        ]:
            # self.driver.get(link)
            self.waitelement(
                By.XPATH,
                '//a[@href="' + link.split("admin/")[1] + '"]',
                "presence_of_element_located",
                "click",
            )
            try:
                os.remove(
                    os.path.join(os.path.dirname(__file__), "temp", link.split("=")[1])
                )
            except OSError:
                pass
            # if windows:
            if os.name == "nt":
                os.rename(
                    os.path.join(get_download_path(), link.split("=")[1]),
                    os.path.join(os.path.dirname(__file__), "temp", link.split("=")[1]),
                )
            else:
                os.rename(
    ...
    def waitelement(self, by, element, func, action, time_max=None):
        ...
        try:
            ...
            wait = WebDriverWait(
                self.driver, time_max, ignored_exceptions=ignored_exceptions
            )
    ...
    def list_installation(self):
        ...
        send_channel_message(
            "cartcreating", {"message": "Connecté à la page des installations"}
        )
        time.sleep(5)
        install = self.waitelement(
            By.XPATH,
            '//*[@class="liste_colonne_paire"]/a[2]',
            "presence_of_all_elements_located",
            None,
            time_max=120,
        )
        ...
        try:
            ...
            if True:
                ...
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "Recherche de l'installation "
                        + installation
                ...
                while i < 40 and not installation in l:
                    ...
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "Tentative "
                            + str(i)
                            + "/40  de recherche de l'installation "
                            + installation
                            + " dans a liste des installations"
                        },
                    )
                    l = self.list_installation()
                """
                ...
                if i == 40:
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "<i class='fas fa-times' style='color: #fe0101;'></i> Abandon de de recherche d'installation "
                            + installation
                        },
                    )
                    self.close()
                    ...
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": '<i class="fas fa-check" style="color: #018303;"></i> Installation '
                            + installation
                            + " dans la liste des installations"
                        },
                    )
                    ...
                    if created:
                        send_channel_message(
                            "cartcreating",
                            {
                                ...
                                + instal
                                + " enregistrée dans le solistools"
                            },
                        )
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "Préparation de l'envoi de la configuration à "
                            + instal
                        },
                    )
                    self.driver.get(
                        "https://my.solisart.fr/admin/index.php?page=installation&id="
                        + instal
                    )
                    i = 0
                    send_channel_message(
                        "cartcreating",
                        {"message": "Attente que la carte " + instal + " se connecte"},
                    )
                    while (
                        self.driver.find_element(By.ID, "comm-statut").get_attribute(
                            "src"
                        )
                        != "https://my.solisart.fr/admin/image/bullet_green.png"
                        and i < 1200
                    ):
                        time.sleep(0.5)
                        print("wait again")
                    ...
                    if i == 1200:
                        ...
                        send_channel_message(
                            "cartcreating",
                            {"message": "La carte " + instal + " est connectée"},
                        )
                        time.sleep(2)
                        # time.sleep(2)
                        self.waitelement(
                        ...
                        self.waitelement(
                            By.XPATH,
                            '//a[@href="#onglet-config"]',
                            "presence_of_element_located",
                            "click",
                        )
                        time.sleep(2)
                        self.driver.find_element(By.ID, "upload-input-3").send_keys(
                            path_csv
                        )
                        time.sleep(2)
                        ...
                        self.driver.find_element(
                            By.XPATH,
                            '//*[@id="liste-configs"]/table/tbody/tr[2]/td[4]/a[1]',
                        ).click()
                        try:
                            self.waitelement(
                                By.XPATH,
                        ...
                        self.waitelement(
                            By.ID,
                            "button-enregistrement-enregistrer",
                            "presence_of_element_located",
                            "click",
                        )
                        send_channel_message(
                            "cartcreating",
                            {
                                "message": "<i class='fas fa-check' style='color: #018303;'></i> Les informations pour "
                                + instal
    ...
    def savekey_installation(self, installation, dict_schematic):
        ...
        try:
            ...
            send_channel_message(
                "cartcreating",
                {"message": "Attente " + installation + " que la carte se connecte"},
            )
            while (
                self.driver.find_element(By.ID, "comm-statut").get_attribute("src")
                != "https://my.solisart.fr/admin/image/bullet_green.png"
                and i < 1200
            ):
                time.sleep(0.5)
            ...
            if i == 1200:
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "<i class='fas fa-times' style='color: #fe0101;'></i> La carte "
                        + installation
                        + " ne s'est pas connecté en 10 min"
                    },
                )
                self.close()
            else:
                send_channel_message(
                    "cartcreating",
                    {"message": "La carte " + installation + " est connectée"},
                )
                assert self.driver.find_element(
                    By.XPATH, '//label[@for="input-pages-info"]'
                )
                time.sleep(2)
                self.driver.find_element(
                    By.XPATH, '//label[@for="input-pages-info"]'
                ...
                time.sleep(2)
                self.driver.find_element(
                    By.XPATH, '//a[@href="#onglet-info-suivi"]'
                ).click()
                self.driver.find_element(
                    By.ID, "mail-defaut-adresses-solisart"
                ).send_keys("sav@solisart.fr")
                ...
                if "adresse_mail" in dict_schematictemp:
                    self.driver.find_element(
                        By.ID, "mail-defaut-adresses-installateur"
                    ).clear()
                ...
                if "installateur" in dict_schematictemp:
                    self.driver.find_element(By.ID, "input-suivi-installateur").clear()
                    self.driver.find_element(
                        By.ID, "input-suivi-installateur"
                    ).send_keys(dict_schematictemp["installateur"])

                self.driver.find_element(
                    By.XPATH, '//a[@href="#onglet-info-client"]'
                ).click()
                for key, value in {
                    ...
                    if key in dict_schematictemp:
                        ...
                        self.driver.find_element(By.ID, value).send_keys(
                            dict_schematictemp[key]
                        )

                self.driver.find_element(
                    By.XPATH, '//a[@href="#onglet-info-localisation"]'
                ).click()
                for key, value in {
                ...
                try:
                    ...
                    url = (
                        ...
                        + dict_schematictemp["adresse_client"]
                        + "&postcode="
                        + dict_schematictemp["code_postale_client"]
                        + "&type=street"
                    )
                    import requests
                    ...
                    if GPS == "46.603354,1.8883335":
                        GPS = None
                    if GPS:
                        self.driver.find_element(By.ID, "input-adresse-gps").send_keys(
                            GPS
                        )
                    ...
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "Les informations GPS pour"
                            + installation
            ...
            self.driver.find_element(
                By.XPATH, '//a[@href="#onglet-enregistrement"]'
            ).click()
    ...
    def cart_created_since_json(self, kwargs):
        ...
        try:
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "Recherche si l'installation "
                    + installation
                    + " existe déjà..."
                },
            )
            ...
            if installation in list_install:
                ...
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "<i class='fas fa-check' style='color: #018303;'></i> Le fichier .csv de configuration de l'installation "
                        + installation
                        + " a bien été créé",
                        "download": "config",
                    },
                ...
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "<i class='fas fa-check' style='color: #018303;'></i> L'image .png sur schéma hydro de l'installation "
                        + installation
                        + " a bien été créée"
                    },
                )
        ...
        self.cart_created_since_csv_config(
            path_csv=os.path.join(os.path.dirname(__file__), "temp", "config.csv")
        )
            ...
            try:
                ...
                if commercial == "NONGLA":
                    ...
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "<i class='fas fa-check' style='color: #018303;'></i> Le commercial "
                            + str(commercial)
                            + " a été affecté à l'installation"
                        },
                    )
                    ...
                    self.acces_installation(
                        "techniconsultant.cc@orange.fr", install, "2"
                    )
                    send_channel_message(
                        "cartcreating",
                        {
        ...
        if self.connecting:
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-check' style='color: #018303;'></i><a href='https://my.solisart.fr/admin/?page=installation&id="
                    + install
                    + "' target='_blank'>Visualiser l'installation "
                    + install
                    + " créée</a>"
                },
            )
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-times' style='color: #fe0101;'></i><a href='https://my.solisart.fr/admin/?page=installation&id="
                    + install
                    + "' target='_blank'>Visualiser l'installation "
                    + install
                    + " créée</a>"
        ...
        try:
            if dict_schematic["mail_client"]:
                ...
                if i == 1200:
                    ...
                    self.waitelement(
                        By.XPATH,
                        '//label[@for="input-pages-acces"]',
                        "presence_of_element_located",
                        "click",
                    )
                    self.waitelement(
                        By.XPATH,
                        '//a[@href="#onglet-acces-ajout-utilisateur"]',
                        "presence_of_element_located",
                        "click",
                    )
                    self.waitelement(
                        By.XPATH,
                        '//option[@value="' + dict_schematic["mail_client"] + '"]',
                        "presence_of_element_located",
                        "click",
                    )
                    self.waitelement(
                ...
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "<i class='fas fa-times' style='color: #fe0101;'></i> Pas assez d'information pour créer le propriétaire"
                    },
                )
        except Exception as ex:
            exc_type, exc_obj, exc_tb = sys.exc_info()
    ...
    def acces_installation(self, idsa, installation, level):
        ...
        try:
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-times' style='color: #fe0101;'></i> "
                    + idsa
                    + " n'a pas pu être affecté."
                },
            )
        ...
        try:
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-check' style='color: #018303;'></i> L'image .png sur schéma hydro de l'installation "
                    + installation
                    + " a bien été affectée à l'onglet visualisation"
                },
            )
    ...
    def cart_created_since_csv_config(self, path_csv=None):
        ...
        if not "SC_TEST" in list_install:
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-times' style='color: #fe0101;'></i> Abandon de de recherche d'installation SC_TEST."
                },
            )
            self.close()
        else:
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-check' style='color: #018303;'></i> SC_TEST dans la liste des installations"
                },
            )
            self.driver.get(
                "https://my.solisart.fr/admin/index.php?page=installation&id=SC_TEST"
            )
            i = 0
            while (
                self.driver.find_element(By.ID, "comm-statut").get_attribute("src")
            ...
            if i == 1200:
                ...
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "<i class='fas fa-times' style='color: #fe0101;'></i> Pas de connection de SC_TEST en 10min."
                    },
                )
                self.close()
            else:
                ...
                if self.connecting:
                    time.sleep(2)
                    self.driver.find_element(
                        By.XPATH, '//label[@for="input-pages-administration"]'
                    ).click()
                    time.sleep(2)
                    import csv
                    ...
                    self.driver.find_element(
                        By.ID, "input-admin-serveur-serie"
                    ).send_keys(installation)
                    self.driver.find_element(By.ID, "input-admin-serveur-id").clear()
                    self.driver.find_element(By.ID, "input-admin-serveur-id").send_keys(
                        proprio
                    )
                    time.sleep(2)
                    self.driver.find_element(
                    ...
                    self.driver.find_element(
                        By.ID, "button-enregistrement-enregistrer"
                    ).click()
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "<i class='fas fa-check' style='color: #018303;'></i> SC_TEST renommé en "
                            + installation
                            + "."
                        },
                    )
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "Début du première envoi de configuration pour l'installation "
                            + installation
                            + "."
                        },
                    )
                    ...
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "<i class='fas fa-check' style='color: #018303;'></i> Première envoi de configuration pour l'installation "
                            + installation
                            + " réussi."
                        },
                    )
                    send_channel_message(
                        "cartcreating",
                        {
                            "message": "Début du seconde envoi de configuration pour l'installation "
                            + installation
                            + "."
                        },
                    )
    ...
    def update_regul(self, installation):
        try:
            ...
            send_channel_message(
                "cartcreating",
                {"message": "Attente que la carte " + installation + " se connecte"},
            )
            self.waitelement(
                By.XPATH,
                '// *[@id="comm-statut"][@src="image/bullet_green.png"]',
                "presence_of_element_located",
                "",
                time_max=1200,
            )
            ...
            send_channel_message(
                "cartcreating",
                {"message": "L'installation " + installation + " est connectée"},
            )
            time.sleep(2)
            self.waitelement(
                By.XPATH,
            ...
            # Valide la màj
            self.waitelement(
                By.ID, "firmware-installer", "presence_of_element_located", "click"
            )
            ...
            send_channel_message(
                "cartcreating",
                {
                    "message": "La carte de régulation de l'installation "
                    + installation
    ...
    def update_nano(self, installation):
        try:
            ...
            self.waitelement(
                By.XPATH,
                '//a[@href="#onglet-serveur"]',
                "presence_of_element_located",
                "click",
            )
            time.sleep(2)
            if self.driver.find_element(By.ID, "appli-courant").get_attribute(
                "innerHTML"
            ) != self.driver.find_element(By.CLASS_NAME, "version").get_attribute(
                "innerHTML"
            ):
                ...
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "Le nano serveur de l'installation "
                        + installation
                ...
                self.waitelement(
                    By.XPATH,
                    '//*[@id="appli-maj"]/table/tbody/tr[2]/td[2]/img[@alt="Terminée avec succès"]',
                    "presence_of_element_located",
                    "",
                    time_max=1200,
                )
            send_channel_message(
                "cartcreating",
                {
                    "message": "<i class='fas fa-check' style='color: #018303;'></i> Le nano server de l'installation "
                    + installation
                    + " est à la dernière version"
                },
            )
    ...
    def downloadConfigCsvInstallation(self, installation):
        ...
        send_channel_message(
            "cartcreating", {"message": "Connexion à l'installation: " + installation}
        )
        time.sleep(2)
        self.waitelement(
            By.XPATH,
        ...
        self.waitelement(
            By.ID, "bouton-sauvegarder", "presence_of_element_located", "click"
        )
        time.sleep(2)
        self.waitelement(
            By.XPATH,
            '//*[@id="liste-configs"]/table/tbody/tr[2]/td[4]/a[2]',
            "presence_of_element_located",
            "click",
        )
        send_channel_message(
            "cartcreating",
            {
                "message": "La configuration de l'installation "
                + installation
                + " vient d'être téléchargée."
            },
        )
        ...
        try:
            ...
            if os.name == "nt":
                os.rename(
                    glob.glob(get_download_path() + "/*.csv")[0],
                    os.path.join(os.path.dirname(__file__), "temp", "config.csv"),
                )
            else:
                send_channel_message(
                    "cartcreating",
    ...
    def createuser(self, dict_schematic):
        try:
            ...
            if (
                "mail_client" in dict_schematic
                and len(dict_schematic["mail_client"]) < 32
            ):
                self.driver.get(
                    "https://my.solisart.fr/admin/index.php?page=creer_utilisateur"
                )
                ...
                for key, value in {
                    ...
                    if key in dict_schematic:
                        self.driver.find_element(
                            By.XPATH, '//input[@name="' + value + '"]'
                        ).clear()
                        self.driver.find_element(
                            By.XPATH, '//input[@name="' + value + '"]'
                        ).send_keys(dict_schematic[key])
                self.driver.find_element(
                    By.XPATH, '//input[@name="pass_saisie"]'
                ).clear()
                self.driver.find_element(
                    By.XPATH, '//input[@name="pass_saisie"]'
                ).send_keys("solaire")
                self.driver.find_element(
                    By.XPATH, '//input[@name="pass_confirm"]'
                ).clear()
                self.driver.find_element(
                    By.XPATH, '//input[@name="pass_confirm"]'
                ).send_keys("solaire")
                self.driver.find_element(By.XPATH, '//input[@name="creation"]').click()
                send_channel_message(
                    "cartcreating",
                    {
                        "message": "<i class='fas fa-check' style='color: #018303;'></i> Le propriétaire "
                        + dict_schematic["prenom_client"]
                        + " "
