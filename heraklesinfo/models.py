...
class B50Composants(models.Model):
    ...
    # t50_20_famille_de_critéres_hiérarchiques = models.CharField(db_column='T50-20-Famille de critéres hiérarchiques', max_length=3, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    # t50_22_famille_de_critéres_libres = models.CharField(db_column='T50-22-Famille de critéres libres', max_length=3, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class B99Affaires(models.Model):
    ...
    t99_7_date_de_cléture = models.DateTimeField(db_column='T99-7-Date de cléture', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class C105LignesDeDevis(models.Model):
    ...
    t105_5_n_ligne_du_devis = models.DecimalField(db_column='T105-5-Né ligne du devis', max_digits=38, decimal_places=17)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    t105_50_déboursé_matiére_heure = models.DecimalField(db_column='T105-50-Déboursé matiére / heure', max_digits=28, decimal_places=15, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
